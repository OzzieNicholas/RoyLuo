        ...
        methods: {
            ...
            addSubpage() {
                try {
                    ...
                    if (!this.$refs.myFileName.files[0] || !this.newSubpage) {
                        alert("请上传文件链接");
                    } else {
                        if (!this.subpageList[this.pageIndex]) {
                            this.subpageList[this.pageIndex] = [];
                        }
                        this.subpageList[this.pageIndex].push({
                            name: this.newSubpage,
                            fileName: this.$refs.myFileName.files[0].name,
                        });
                        this.addSubpageDialogVisible = false;
                    }
            ...
            doSomeThing(fileName) {
                ...
                this.test(`user/${fileName.split('.')[0]}`)
            },
            //删
            delPage() {
